...
namespace SampleEF.Data.Migrations
{
    ...
    [Migration("20220512043737_contohstoreprocedure")]
    partial class contohstoreprocedure
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SampleEF.Domain.BattleSamurai", b =>
                {
                    b.Property<int>("BattleId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SampleEF.Domain.Horse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SampleEF.Domain.SamuraiBattleStat", b =>
                {
            ...
            modelBuilder.Entity("SampleEF.Domain.BattleSamurai", b =>
                {
                    b.HasOne("SampleEF.Domain.Battle", null)
                        .WithMany()
                        .HasForeignKey("BattleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SampleEF.Domain.Samurai", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SampleEF.Domain.Horse", b =>
                {
                    b.HasOne("SampleEF.Domain.Samurai", null)
                        .WithOne("Horse")
                        .HasForeignKey("SampleEF.Domain.Horse", "SamuraiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
